        ...
        <div class="wrapper">
							...
							<table bgcolor="#333" width="100%"><tr>
                                ...
                                <div class="btn-box-row row-fluid">
                                    <form method="POST" action="">
                                        <a href="rms_report1.php" class="btn-box small span4"><img class="img-circ" src="rmsicons/rep.png" align="center" />
                                        <h5 class="text-muted">Records Inventory and Appraisal Reports</h5></a>
                                    </form>
                                    <form method="POST" action="">
                                        <button class="btn-box small span4" name="rep2"><img class="img-circ" src="rmsicons/rep.png" align="center" />
                                        <h5 class="text-muted">List of Active Files</h5></button> 
                                    </form>
                                    <form name="editdetails" method="POST" action="">
                                        <button class="btn-box small span4" name="rep3"><img class="img-circ" src="rmsicons/rep.png" align="center" />
                                        <h5 class="text-muted">Files on Storage</h5></button> 
                                    </form>
            ...
            <?php
                ...
                <div id="myalert" style="display:<?php echo $display ?>;">
                  <div id="header">
                  <form action="gen_reports.php" method="post">
                        <button type="submit" class="close">&times;&nbsp;&nbsp;&nbsp;</button>
                  </form>
           <form method="POST" action="rms_report2.php" class="form-horizontal row-fluid">
           
                        <center>
                        <br><h5 class="text-muted">List of Active Files Report</h5><hr>
                        </center>
                        <div>
           ...
           <form method="POST" action="rms_report3.php" class="form-horizontal row-fluid">
                        <center>
                        <br><h5 class="text-muted">Files on Storage</h5><hr>
                        </center>
                        <div>
                          <label for="basicinput">Select Type: </label>
                          <select class="span8" name="type" id="basicinput" >
                ...
                ?> 
                                <div class="btn-box-row row-fluid">
                                <form method="POST" action="">
                                        <a href="rms_report5.php" class="btn-box small span4"><img class="img-circ" src="rmsicons/rep.png" align="center" />
                                        <h5 class="text-muted">Records for Disposal</h5></a>
                                    </form>
                                </div>
