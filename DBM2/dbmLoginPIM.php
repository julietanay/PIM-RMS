        ...
        <section class="intro">
			<div class="inner">
				...
				<a href="dbmHomepage.php" title="back to home" class="btnH">Home</a>
					...
					<img src="images/pimlogoo.png" class="photo">
					<div align="center"><font color="#666666"><h3>Login as: <small>Human Resource(HR) Admin<small/></h3></font> </div>
					<form ACTION="<?php echo $loginFormAction; ?>" method="POST" class="form-vertical" id="loginform">
						<span id="sprytextfield1">
							 <input class="input1" type="text" id="inputEmail" placeholder="Username..." name="username"><p align="center">
							<span  class="textfieldRequiredMsg">A value is required.</span></p>
						</span>
						<span id="sprytextfield2">
							<input class="input2" type="password" id="inputPassword" placeholder="Password..." name="password">
							<p align="center">
							<span  class="textfieldRequiredMsg">A value is required.</span></p>
						</span>
