...
<body>
												...
												<?php 
												    ...
												    if(mysql_query($update)){?>
														...
														window.location.href="dbmPIMUserIndex.php?perId=<?php echo $per;?>";
													    </script>
													<?php
													} else {
														?> <script type="text/javascript">
														alert("OOOPSS, Something went wrong!! Are you sure this is the photo? : This error is either caused by: - another user is currently in use of the selected photo - the file name of the selected photo is the same with the other user(s) photo ");
														window.location.href="dbmPIMUserIndex.php?perId=<?php echo $per;?>";
														 </script>
													<?php 	}
													}else
