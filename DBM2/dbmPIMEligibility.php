...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formEli")) {
  $insertSQL = sprintf("INSERT INTO eligibility (elName, elRating, elDate, elPlace, elNumber, elDateValid, elDateModified, perId) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "dbmPIMEligibility.php?perId=" . $row_Recordset1['perId'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
              ...
              <ul class="profile-tab nav nav-tabs">
				...
				<li><a href="dbmPIMWork.php?perId=<?php echo $persid; ?>">Work Experience</a></li>
								...
								<p></p>
										...
										<tbody>
										<tr>
											<td><h4>Civil Service Eligibility </h4></td>
											<td> <div align="right"><form method="post" action=" "><button name="btnEli" id="btnEli" class="btn btn-large btn-info">Add Eligibility<i class="icon-plus"></i></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</form></div></td>
										</tr>
										<tr>
										<td colspan=2>
										<table align="center" width=100% class="table table-striped table-bordered table-condensed">
											...
											<tr>
											<td><table width="100%" class="table" border="1">
										   <tr>
											  <td width="47"><?php echo '<div align="center"><strong>'.$countm.'.)</strong></div>'; ?></td>
											  <td colspan="3"><div align="right"><button class="btn btn-mini btn-primary">Update</div></td>
											</tr>
											<tr>
											  <td colspan="2" ><div align="center"><strong><small>Career Service/ RA 1080 (Board/ Bar) Under Special Laws/ CES/CSEE Barangay Eligibility / Driver's License :</small></strong></div></td>
											  <td width="164" rowspan="2"><p></p><div align="center"><strong>License</strong></div> <font size="-2"><div align="center">(if applicable)</div></font></td>
											  <td><strong>Number : <?php if ($elNumber==null || $elNumber==" "){
												  echo '<div align="center" class="text-warning">N/A (Not Applicable)</div>';
											  } else{
												   echo '<div align="center" class="text-warning">'.$elNumber.'</div>';
											  } ?></strong></td>
											</tr>
											<tr>
											  <td colspan="2"><div align="center" ><strong class="text-warning"><?php echo $elName; ?></strong></div></td>
											  <td width="164"><strong>Date of Validity : <?php if ($elDateValid==null || $elDateValid==" "){
												  echo '<div align="center" class="text-warning">N/A (Not Applicable)</div>';
											  } else{
												   echo '<div align="center" class="text-warning">'.$elDateValid.'</div>';
											  } ?></strong></td>
											</tr>
											<tr>
											  <td colspan="2"><div align="center"><strong>Place of Examination / Conferment :</strong></div></td>
											  <td><div align="center"><strong><small>Date of Examination/ Conferment :</small></strong></div></td>
											  <td><div align="center"  ><strong class="text-warning"> <?php if ($elDate==null || $elDate==" "){
												  echo '<div align="center" class="text-warning">N/A (Not Applicable)</div>';
											  } else{
												   echo '<div align="center" class="text-warning">'.$elDate.'</div>';
											  } ?></strong></div></td>
											</tr>
											<tr>
											  <td colspan="2"><div align="center"  ><strong class="text-warning"><?php echo $elPlace; ?></strong></div></td>
											  <td><div align="center"><strong>RATING : </strong> <font size="-2">(If Applicable)</font></div></td>
											  <td><div align="center"  ><strong class="text-warning"><?php if ($elRating==null || $elRating==" "){
												  echo '<div align="center" class="text-warning">N/A (Not Applicable)</div>';
											  } else{
												   echo '<div align="center" class="text-warning">'.$elRating.'</div>';
											  } ?></strong></div></td>
											</tr>
										  </table><p></p>
										  </td>
										...
										<?php if ($countm==0){?>
										<tr>
											<td colspan=6><p></p><div align="center">*** NO RECORD FOUND ***</div><p></p>
								...
								<?php if(isset($_POST['btnEli'])){ ?>
										<div id="myalert"  style="display:<?php echo $display ?>;">
										  <div id="header">
											<form action="dbmPIMEligibility.php?perId=<?php echo $perIdm; ?>" method="post">
											  <button type="submit" class="close">&times;&nbsp;&nbsp;&nbsp;</button>
											</form>
											<p>&nbsp;</p>
											<center>
											  <h3 class="modal-title"><b> &nbsp;Eligibility</b></h3>
											</center>
											<hr>
											<center>
											...
											<table width="54%" border="0" align="center">
											  <tr>
												<td align="center"><label for="elName">Eligibility Title</label>
												<input type="text" name="elName" id="elName" placeholder="Required" class="span4" required/>
											   </td>
											  </tr>
											  <tr>
												<td align="center"><label for="elRating">Rating (if applicable) <input type="checkbox" onclick="
												var input = document.getElementById('elRating');
												if(this.checked){ 
												...
												<input type="text" name="elRating" id="elRating" placeholder="check box if Applicable..." class="span4" disabled="disabled" required/>
											   </td>
											  </tr>
											  <tr>
												<td align="center"><label for="elDate">Date of Examination/ Conferment</label>
												<input type="date" name="elDate" id="elDate" placeholder="check box if Applicable..." class="span4" required/>
											   </td>
											  </tr>
											  <tr>
												<td align="center"><label for="elPlace">Place of Examination/ Conferment</label>
												<input type="text" name="elPlace" id="elPlace" placeholder="check box if Applicable..." class="span4" required/>
											   </td>
											  </tr>
											  <tr>
												<td align="center">
												<table border="0" >
													   <tr>
													   <td colspan=2><label >License (if applicable) <input type="checkbox" onclick="
												var input = document.getElementById('elNumber');
												var input1 = document.getElementById('elDateValid');
												if(this.checked){ 
												input.disabled = false; input.focus();
												input1.disabled = false; input1.focus()
												
												} else{
													input.disabled=true;
													input1.disabled=true;}" /></label></td>
													   </tr>
													  <tr>
														<td align="right">Number : </td>
														<td><input type="text" name="elNumber" id="elNumber" placeholder="check box if Applicable..." class="span3" disabled="disabled" required/></td>
													  </tr>
													  <tr>
														<td>Date of Validity : </td>
														<td><input type="date" name="elDateValid" id="elDateValid" placeholder="check box if Applicable..." class="span3" disabled="disabled" required/></td>
													  </tr>
													</table>
											   </td>
											  </tr>
											  <tr>
											  <td><p></p>
											  <input type="hidden" name="perId" id="perId" value=<?php echo $perIdm;; ?> >
                                              <input type="hidden" name="elDateModified" id="elDateModified" value=<?php echo date('Y-m-d'); ?> >
											  <input type="submit" name="eligibility" id="eligibility" value="Submit" class="btn btn-large btn-inverse pull-right">
