    ...
    <td width="247">
     ...
     <td width="770" ><div>
	   ...
	   <?php 					
		...
		<tr>
		<td colspan=4><p>&nbsp;</p><div align="center"><h4><strong>Work Experience</strong></h4></div></td>
		</tr>
</table>
</td>
  </tr>
        ...
        <td colspan="7"><div align="center">
                <table width="850" border="1">
				 <tr>
					...
					<td rowspan="2"><div align="center"><strong>Position Title</strong></div></td>
					<td rowspan="2"><div align="center"><strong>Department/ Agency/ Office/ Company</strong></div></td>
					<td rowspan="2"><div align="center"><strong>Monthly Salary</strong></div></td>
					<td rowspan="2"><div align="center"><strong>Salary/ Job/ Pay Grade &amp; Step Increment</strong></div></td>
					<td rowspan="2"> <div align="center"><strong>Status of Appointment </strong></div></td>
					<td rowspan="2"><div align="center"><strong>Gov't Service</strong></div></td>
				  </tr>
				  <tr>
					<td><div align="center"><strong>From</strong></div></td>
					<td><div align="center"><strong>To</strong></div></td>		 
				 </tr>
                  <?php $perIdwork=$row_Recordset1['perId'];
                  ...
                  <tr>
					<td><div align="center"><?php 
						 $d = date_parse_from_format("Y-m-d", $workFrom);
						 $month=$d["month"];
						 $day=$d["day"];
						 $Year=$d["year"];
						 echo ''.$month.'-'.$day.'-'.$Year;
					?></div></td>
					<td><div align="center"><?php 
						 $d = date_parse_from_format("Y-m-d", $workTo);
						 $month=$d["month"];
						 $day=$d["day"];
						 $Year=$d["year"];
						 echo ''.$month.'-'.$day.'-'.$Year;
					...
					<td><div align="center"><?php echo $workSalary1.'-'.$workSalary1.'';?></div></td>
