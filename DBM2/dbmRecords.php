...
#header {
  ...
  border-bottom-right-radius: 15px;
    ...
    <head>
        ...
        <title>RMS - Records Section</title>
                    ...
                    <div class="span9">
                        <div class="content">
							...
							<table bgcolor="#333" width="100%"><tr>
								...
								<form action="dbmRecords.php" method="POST">
                                <table width="100%">
                                 <td align="right">
                                    <button class="btn btn-success" name="adsearch"><i class="menu-icon icon-search"></i> Advance Search</button>
                                 </td>
                                   </table>
                                 </form>
        <?php
                ...
                <form method="POST" action="dbmRecords.php" class="form-horizontal row-fluid">
            ...
            <?php
                ...
                if($sqlsearch){
                    $countresult = mysql_num_rows($sqlsearch);
                        ...
                        echo "<table cellpadding='0' cellspacing='0' border='0' class='table-striped table-bordered table-condensed' width='100%'>";
                        echo "<thead>";
                        echo "<tr>";
                        echo "<th class='span1'>Series No.</th>";
                        echo "<th class='span3'>Title</th>";
                        echo "<th>Date</th>";
                        echo "<th class='span3'>Purpose</th>";
                        echo "<th>Amount</th>";
                        echo "<th>Agency</th>";
                        echo "<th>Type</th>";
                        echo "</tr>";
                        ...
                        echo "<td><a href='images.php?fileid=$file_id'>".$series_no."</a></td>";
                        echo "<td>". $title."</td>";
            ...
            echo "<script>
            window.location.href='dbmRecords.php'
            </script>";
...
?>                 
                        ...
                        <table border="0" class="table-bordered table-striped display" width="100%"><tr>
                                ...
                                <?php
                                $typeqry=mysql_query("SELECT * FROM type ORDER BY type_id limit 0,4");
                                while($rows = mysql_fetch_array($typeqry)){
                                    $type = $rows['type_id'];
                                    $type_name = $rows['type_name'];
                                   
                                    echo "<a href='file_cat.php?type=$type' class='btn-box small span3'><img class='img-circ' src='rmsicons/recs.png' align='center' />";
                                    echo "<h5 class='text-muted'>".$type_name."</h5></a>";
                                ...
                                <div class="btn-box-row row-fluid">
                                <?php
                                $typeqry=mysql_query("SELECT * FROM type ORDER BY type_id limit 4,4");
                                while($rows = mysql_fetch_array($typeqry)){
                                    $type = $rows['type_id'];
                                    $type_name = $rows['type_name'];
                                ...
                                <div class="btn-box-row row-fluid">
                                <?php
                                $typeqry=mysql_query("SELECT * FROM type ORDER BY type_id limit 8,4");
                                while($rows = mysql_fetch_array($typeqry)){
                                    $type = $rows['type_id'];
                                    $type_name = $rows['type_name'];
                                ...
                                <?php
                                $typeqry=mysql_query("SELECT * FROM type ORDER BY type_id limit 12,4");
                                $count=mysql_num_rows($typeqry);
                                if($count != 0){
