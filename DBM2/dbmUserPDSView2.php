...
<table width="900" border="1" align="center">
  ...
  <tr>
    <td width="287" rowspan="2" id="bgcolor1"><div align="center">
    <font size="-1">27.</font>&emsp; <font size="-1">  CAREER SERVICE/ RA 1080 (BOARD/ BAR) UNDER SPECIAL LAWS/ CES/ CSEE                                                    BARANGAY ELIGIBILITY / DRIVER'S LICENSE</font></div></td>
    <td width="116" rowspan="2" id="bgcolor1"><div align="center"><font size="-1">RATING<br />
    (If Applicable)</font></div></td>
    <td width="121" rowspan="2" id="bgcolor1"><div align="center"><font size="-1">DATE OF EXAMINATION / CONFERMENT</font></div></td>
    <td width="234" rowspan="2" id="bgcolor1"><div align="center"><font size="-1">PLACE OF EXAMINATION / CONFERMENT</font></div></td>
    <td height="25" colspan="2" id="bgcolor1"><div align="center"><font size="-1">LICENSE (if applicable)</font></div></td>
  </tr>
  <tr>
 ...
 <?php  			$perId=$row_Recordset1['perId'];
					...
					while($rowm = mysql_fetch_assoc($resultm)) {
						...
						$elDateValid=$rowm['elDateValid'];
						 ?>
  <tr>
    <td height="24"><div align="center"><?php echo $elName ?></div></td>
...
<table width="900" border="1" align="center">
  <tr>
    ...
    <i>(Include private employment.  Start from your recent work) Description of duties should be indicated in the attached Work Experience sheet.)</i></div></td>
  </tr>
  <tr>
    <td height="43" colspan="2" id="bgcolor1"><div align="center"><font size="-1">28.</font>&emsp; <font size="-1">INCLUSIVE DATES <br>
      (mm/dd/yyyy)</font></div></td>
    <td width="194" rowspan="2" id="bgcolor1"><div align="center">
      <font size="-1">POSITION TITLE <br>      
     (Write in full/Do not abbreviate)
    </font></div></td>
    <td width="162" rowspan="2" id="bgcolor1"><div align="center"><font size="-1">DEPARTMENT / AGENCY / OFFICE / COMPANY<br>  (Write in full/Do not abbreviate)</font></div></td>
    <td width="78" rowspan="2" id="bgcolor1"><div align="center"><font size="-1">MONTHLY SALARY</font></div></td>
    <td width="122" rowspan="2" id="bgcolor1"><div align="center"><font size="-1">SALARY/ JOB/ PAY GRADE <br>(if applicable)&amp; STEP  (Format &quot;00-0&quot;)/ INCREMENT</font></div></td>
    <td width="85" rowspan="2" id="bgcolor1"><div align="center"><font size="-1">STATUS OF APPOINTMENT</font></div></td>
    <td width="73" rowspan="2" id="bgcolor1"><div align="center"><font size="-1">GOV'T SERVICE<br>(Y/ N)</font></div></td>
  </tr>
  <tr>
    <td width="67" height="29" id="bgcolor1"><div align="center"><font size="-1">From</font></div></td>
  ...
  <tr>
    ...
    <td><div align="center"><?php echo $workSalary; ?></div></td>
...
<table width="900" border="1" align="center">
 ...
 <a href="dbmPIMUserIndex.php?perId=<?php echo $row_Recordset1['perId']; ?>" class="btn btn-danger loading bold"> Back</a> 
    <a href="dbmUserPDSView.php?perId=<?php echo $row_Recordset1['perId']; ?>" class="btn btn-danger loading bold"> P1 </a> 
    <a href="#" class="btn btn-danger loading bold active"> P2 </a>  &nbsp; &nbsp;
