											...
											<table>
												...
												if(!$filetmp){
														...
														echo "image only please!!!";
															...
															//echo $filetmp2;
															$sql= "insert into profile_pics (picname, image, picType, perId) values ('".$filename."', '".$filetmp2."', '".$filetype."', 1)";
													...
													if ( $width > $maxDim || $height > $maxDim ) 
													{
														...
														$sql= "insert into profile_pics (picname, image, picType, perId) values ('".$filename."', '".$filetmp3."', '".$filetype."', 2)";
															$result= mysql_query($sql);
															if($result)
																{
																	echo "inserted";
