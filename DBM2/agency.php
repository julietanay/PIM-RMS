                    ...
                    <div class="span9">
                        <div class="content">
							...
							<table bgcolor="#333" width="100%"><tr>
								...
								<td align="right"><h3>
                              <!--  <a href="dbmPIMpersonnelADD.php" class="btn btn-large btn-inverse pull-right"><i class="icon-plus shaded"></i> Add Personnel</a>-->
								</h3></td>
								</tr></table>
                                   ...
                                   <table cellpadding="0" cellspacing="0" border="0" class="table-bordered table-striped	 display"
                                    ...
                                    <tr>
                                     ...
                                     <tbody>
                                        ...
                                        $query = mysql_query("SELECT * FROM agency WHERE subtype_id = '$subtype'");
