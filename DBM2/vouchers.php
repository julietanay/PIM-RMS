        ...
        <div class="wrapper">
            <div class="container">
              ...
              <ul class="widget widget-menu unstyled">
                                ...
                                <li><a class="collapsed" data-toggle="collapse" href="#togglePages"><i class="menu-icon icon-briefcase">
                                    ...
                                    <li><a href="allotmentfiles.php"><i class="icon-inbox"></i>Allotment Files</a></li>
                                        ...
                                        <li><a href="files.php?type=6"><i class="icon-inbox"></i>Acknowledgement Receipts</a>
                                        <a href="remittances.php"><i class="icon-inbox"></i>List of Remittances</a></li>
              ...
              <table bgcolor="#333" width="100%"><tr>
               ...
               <td align="right"><h3>
                               <a href=<?php echo "addnewrec.php?typeid=11"; ?> class="btn btn-large btn-inverse pull-right"><i class="icon-plus shaded"></i> Add New</a>
                </h3></td>
                </tr></table>
                                   ...
                                   <table cellpadding="0" cellspacing="0" border="0" class="table-bordered table-striped   display"
                                    ...
                                    <tr>
                                     ...
                                     <tbody>
                                         ...
                                         <?php
                                         $subtype = mysql_query("SELECT * FROM sub_type WHERE type_id = 11");
                                         $no = 0;
                                         while($rows = mysql_fetch_array($subtype)){
                                            ...
                                            echo "<tr>";
                                            echo "<td>".$no."</td>";
                                            echo "<td><ul><li><a href='files.php?subtype=$stype_id&&type=11'>".$sub."</a>";
