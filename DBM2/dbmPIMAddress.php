...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "addResidential")) {
  $insertSQL = sprintf("INSERT INTO address (houseNo, street, subdivision, barangay, city, province, addressType, addDateModified, perId, zipcode) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['houseNo'], "int"),
                       GetSQLValueString($_POST['street'], "text"),
                       GetSQLValueString($_POST['subdivision'], "text"),
                       GetSQLValueString($_POST['barangay'], "text"),
                       GetSQLValueString($_POST['city'], "text"),
                       GetSQLValueString($_POST['province'], "text"),
                       GetSQLValueString($_POST['addressType'], "text"),
                       GetSQLValueString($_POST['addDateModified'], "date"),
  ...
  $insertGoTo = "dbmPIMAddress.php?perId=" . $row_Recordset1['perId'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "addPermanent")) {
  $insertSQL = sprintf("INSERT INTO address (houseNo, street, subdivision, barangay, city, province, addressType, addDateModified, perId, zipcode) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['houseNo'], "int"),
                       GetSQLValueString($_POST['street'], "text"),
                       GetSQLValueString($_POST['subdivision'], "text"),
            ...
            <div class="module-body">
              ...
              <ul class="profile-tab nav nav-tabs">
               <li ><a href="dbmPIMpersonnelView.php?perId=<?php echo $persid; ?>" >Personal</a></li>
				...
				<li class="active"><a href="dbmPIMAddress.php?perId=<?php echo $persid; ?>">Address</a></li>
				...
				<li><a href="dbmPIMWork.php?perId=<?php echo $persid; ?>">Work Experience</a></li>
								...
								<p></p>
										...
										<table align="center" class="table table-striped table-bordered table-condensed">
											...
											$querym = "select * from Address where address.perId=$perIdm and address.addressType='Permanent'";
											...
											$hn=$rowm['houseNo'];
											$strt=$rowm['street'];
											$sub=$rowm['subdivision'];
											$bar=$rowm['barangay'];
											$city=$rowm['city'];
											$prov=$rowm['province'];
											$date=$rowm['addDateModified'];
											$zip=$rowm['zipcode'];
											$addtype=$rowm['addressType'];
											?>
											
											<td><?php echo '<div> House No : '.$hn.' </div>'; 
														echo '<div> Street : '.$strt.' </div>';		
											?></td>
											<td><?php 
														echo '<div> Subdivision : '.$sub.' </div>';
														echo '<div> Barangay : '.$bar.' </div>';
											?></td>
											<td><?php echo '<div> City : '.$city.' </div>';
														echo '<div>  Province : '.$prov.' </div>';
														echo '<div> Zip Code : '.$zip.' </div>'; ?></td>	
										...
										<tr>
											...
											<div align="center"><form method="post" action=" "><button name="btnPer" id="btnPer" class="btn btn-large btn-info">Add Address<i class="icon-plus"></i></button></form></div>
											</td>
										</tr>
										<?php } ?>
											</table>
								...
								<?php if(isset($_POST['btnPer'])){ ?>
										<div id="myalert"  style="display:<?php echo $display ?>;">
										  <div id="header">
											<form action="dbmPIMAddress.php?perId=<?php echo $perIdm; ?>" method="post">
											  <button type="submit" class="close">&times;&nbsp;&nbsp;&nbsp;</button>
											</form>
											<p>&nbsp;</p>
											<center>
											  <h3 class="modal-title"><b> &nbsp;Permanent Address</b></h3>
											</center>
											<hr>
											<center>
                                              <form action="<?php echo $editFormAction; ?>" name="addPermanent" method="POST">
						<table align="center" width="70%" border=0>
                        <tr align="center" >
                          <td ><label  for="famFname">House/Block/Lot No.</label> </td>
                           <td >  <input type="text" placeholder="Required..." name="houseNo" id="houseNo" class="span3" >
                          </td>
                        </tr>
						<tr align="center" >
                          <td ><label  for="famFname">Street</label> </td>
                           <td >  <input type="text" placeholder="Required..." name="street" id="street" class="span3" >
                          </td>
                        </tr>
						<tr align="center" >
                          <td ><label  for="famFname">Subdivision/Village</label> </td>
                           <td >  <input type="text" placeholder="Required..." name="subdivision" id="subdivision" class="span3" >
                          </td>
                        </tr>
						<tr align="center" >
                          <td ><label  for="famFname">Barangay</label> </td>
                           <td >  <input type="text" placeholder="Required..." name="barangay" id="barangay" class="span3" required>
                          </td>
                        </tr>
						<tr align="center" >
                          <td ><label  for="famFname">City/Municipality</label> </td>
                           <td >  <input type="text" placeholder="Required..." name="city" id="city" class="span3" required>
                          </td>
                        </tr>
						<tr align="center" >
                          <td ><label  for="famFname">Province</label> </td>
                           <td >  <input type="text" placeholder="Required..." name="province" id="province" class="span3" required>
                          </td>
                        </tr>
						<tr align="center" >
                          <td ><label  for="famFname">Zip Code</label> </td>
                           <td >  <input type="text" placeholder="Required..." name="zipcode" id="zipcode" class="span3" required>
                          </td>
                        </tr>
                        ...
                        <tr align="center">
                          <td>&nbsp;</td>
						   <td>
						     <input name="addressType" id="addressType" type="hidden" value="Permanent">
						     <input name="addDateModified" id="addDateModified" type="hidden" value="<?php echo date('Y-m-d'); ?>">
                             <input name="perId" id="perId" type="hidden" value="<?php echo $row_Recordset1['perId']; ?>">
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input name="fambtn"type="submit" value="Add Address" class="btn btn-large btn-inverse pull-center"></td>
                        </tr>
                        </table>
<input type="hidden" name="MM_insert" value="addPermanent">
							...
							<!-------Residential -->			
									...
									<table align="center" class="table table-striped table-bordered table-condensed">
										...
										<table align="center" class="table table-striped table-bordered table-condensed">
											 ...
											 <?php 
											$perIdm=$row_Recordset1['perId'];
											$querym = "select * from Address where address.perId=$perIdm and address.addressType='Residential'";
											$resultm= mysql_query($querym);	
											$countm=0;
											while($rowm = mysql_fetch_assoc($resultm)) {
											$perIdAdd=$rowm['perId'];
										...
										<tr>
											<td colspan=3><div align="center">NO RECORD FOUND</div>
											<div align="center"><form method="post" action=" "><button name="btnRes" id="btnRes" class="btn btn-large btn-info">Add Address<i class="icon-plus"></i></button></form></div>
											</td>
										</tr>
										<?php } ?>
											</table>
								...
								<?php if(isset($_POST['btnRes'])){ ?>
										<div id="myalert"  style="display:<?php echo $display ?>;">
										  <div id="header">
											...
											<p>&nbsp;</p>
											<center>
											  <h3 class="modal-title"><b> &nbsp;Residential Address</b></h3>
											</center>
											<hr>
											<center>
                                              <form action="<?php echo $editFormAction; ?>" name="addResidential" method="POST">
						<table align="center" width="70%" border=0>
                        <tr align="center" >
                          <td ><label  for="famFname">House/Block/Lot No.</label> </td>
                           <td >  <input type="text" placeholder="Required..." name="houseNo" id="houseNo" class="span3" required>
                          </td>
                        </tr>
						<tr align="center" >
                          <td ><label  for="famFname">Street</label> </td>
                           <td >  <input type="text" placeholder="Required..." name="street" id="street" class="span3" required>
                          </td>
                        </tr>
						<tr align="center" >
                          <td ><label  for="famFname">Subdivision/Village</label> </td>
                           <td >  <input type="text" placeholder="Required..." name="subdivision" id="subdivision" class="span3" required>
                          </td>
                        </tr>
						<tr align="center" >
                          <td ><label  for="famFname">Barangay</label> </td>
                        ...
                        <tr align="center">
                          <td>&nbsp;</td>
						   <td>
						     <input name="addressType" id="addressType" type="hidden" value="Residential">
						     <input name="addDateModified" id="addDateModified" type="hidden" value="<?php echo date('Y-m-d'); ?>">
                             <input name="perId" id="perId" type="hidden" value="<?php echo $row_Recordset1['perId']; ?>">
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input name="fambtn"type="submit" value="Add Address" class="btn btn-large btn-inverse pull-center"></td>
...
<input type="hidden" name="MM_insert" value="addResidential">
