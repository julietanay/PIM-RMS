    ...
    <td width="247">
     ...
     <td width="770" ><div>
	   ...
	   <?php 					
		...
		<tr>
		<td colspan=4><p>&nbsp;</p><div align="center"><h4><strong>Civil Service Eligibility</strong></h4></div></td>
		</tr>
</table>
</td>
  </tr>
      ...
      <tr>
        <td colspan="7"><div align="center">
                <table width="850" border="1">
				 <tr>
					    <td rowspan="2"><div align="center"><small><strong>Career Service/ RA 1080 (Board/ Bar) Underb</div><div align="center"> Special Laws/ CES/CSEE</div><div align="center"> Barangay Eligibility / Driver's License</strong></small></div></td>
						<td rowspan="2"><div align="center"><strong>Rating </strong></div></td>
						<td rowspan="2"><div align="center"><strong>Date of Examination/ Conferment </strong></div></td>
						<td rowspan="2"><div align="center"><strong>Place of Examination / Conferment</strong></div></td>
						<td colspan="2"><div align="center"><strong>License</strong></div></td>
			     </tr>
				 <tr>
						<td><div align="center"><strong>Number</strong></div></td>
						<td><div align="center"><strong>Date of Validity</strong></div></td>		 
				 </tr>
                  <?php $perIdm=$row_Recordset1['perId'];
						$querym = "select * from eligibility where eligibility.perId=$perIdm order by elId desc";
                  ...
                  <tr>
					<td><div align="center"><?php echo $elTitle; ?></div></td>
					<td><div align="center"><?php if($elRating!=null){
						 echo $elRating;
					}else{
						echo "<small>N/A (Not Applicable)</small>";
					} ?></div></td>
					<td><div align="center"><?php 
						 $d = date_parse_from_format("Y-m-d", $elDate);
						 $month=$d["month"];
						 $day=$d["day"];
						 $Year=$d["year"];
						 echo ''.$month.'-'.$day.'-'.$Year;
					...
					?></div></td>
					<td><div align="center"><?php echo $elPlace; ?></div></td>
					<td><div align="center"><?php if($elNumber!=null){
						 echo $elRating;
					}else{
						echo "<small>N/A (Not Applicable)</small>";
					} ?></div></td>
					<td><div align="center"><?php if($elDateValid!=null){
						// echo $elDateValid;
						 $d = date_parse_from_format("Y-m-d", $elDateValid);
						 $month=$d["month"];
						 $day=$d["day"];
						 $Year=$d["year"];
						 echo ''.$month.'-'.$day.'-'.$Year;
