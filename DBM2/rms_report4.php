...
<table width="900" border="0">
  ...
  //  echo $type_id;
    ...
    ?>
   <tr align="center">
      <td><h3><b>FILES FOR ARCHIVAL</b></h3></td>
    </tr>
    <tr align="left">
...
<tr>
  ...
  <?php
          $qry3=mysql_query("SELECT * FROM file WHERE status='archive' AND type_id='$type' AND subtype_id='$subtype'");
...
<?php
  ...
  <?php
          $qry3=mysql_query("SELECT * FROM file WHERE status='archive' AND type_id='$type'");
          while($row3=mysql_fetch_array($qry3)){
            $series_no=$row3['series_no'];
            $title=$row3['title'];
            $file_date=$row3['file_date'];
