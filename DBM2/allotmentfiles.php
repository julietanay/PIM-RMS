                    ...
                    <div class="span9">
                        <div class="content">
							...
							<table bgcolor="#333" width="100%"><tr>
								...
								<td align="right"><h3>
                               <a href="addnewrec.php?typeid=1" class="btn btn-large btn-inverse pull-right"><i class="icon-plus shaded"></i> Add New</a>
								</h3></td>
								</tr></table>
                                   ...
                                   <table cellpadding="0" cellspacing="0" border="0" class="table-bordered table-striped	 display"
                                    ...
                                    <tr>
                                     ...
                                     <tbody>
                                         ...
                                         <?php
                                         $subtype = mysql_query("SELECT * FROM sub_type WHERE type_id = 1");
                                         $no = 0;
                                         while($rows = mysql_fetch_array($subtype)){
                                            ...
                                            echo "<tr>";
                                            echo "<td>".$no."</td>";
                                            echo "<td><ul><li>".$sub."<ul>";
                                            $agency = mysql_query("SELECT DISTINCT agency FROM file WHERE subtype_id='$stype_id'");
                                            while ($ag=mysql_fetch_array($agency)) {
                                               $agency_name = $ag['agency'];
                                               echo "<li><a href='files.php?agency=$agency_name&&subtype=$stype_id&&type=1'>".$agency_name. "</a></li>";
                                            }
                                            echo "</ul>
                                                  </li>
                                                  </ul>
