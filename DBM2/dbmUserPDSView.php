...
<div align="center">
  ...
  <tr>
    <td><font size="-2"><small>Print legibly. Tick appropriate boxes (     ) and use separate sheet if necessary. Indicate N/A if not applicable.<span class="ArialBlack"> DO NOT ABBREVIATE.</span></small></font></td>
  </tr>
</table>
</td>
        ...
        <table width="900" align="center" border="1">
         ...
         <div>&nbsp;</div>
          ...
          <td width="364"><div align="center">
            <table width="340" border="0">
              <tr>
                <td width="156"><div align="center"><?php echo $row_permanentAdd['houseNo']; ?></div>
                  <div>
                    <div align="center"><font size="-2">House/Block/Lot No.</font></div>
                    </div></td>
                <td width="142"><div align="center"><?php echo $row_permanentAdd['street']; ?></div>
                  <div>
                    <div align="center"><font size="-2">Street</font></div>
                    </div></td>
                </tr>
          ...
          <td width="364"><div align="center">
            <table width="340" border="0">
              <tr>
                <td width="156"><div align="center"><?php echo $row_permanentAdd['subdivision']; ?></div>
                  <div>
                    <div align="center"><font size="-2">Subdivision/Village</font></div>
                    </div></td>
                <td width="142"><div align="center"><?php echo $row_permanentAdd['barangay']; ?></div>
                  <div>
                    <div align="center"><font size="-2">Barangay</font></div>
                    </div></td>
                </tr>
          ...
          <td width="364"><div align="center">
            <table width="340" border="0">
              <tr>
                ...
                <td width="142"><div align="center"><?php echo $row_permanentAdd['province']; ?></div>
                  <div>
                    <div align="center"><font size="-2">Province</font></div>
                    </div></td>
                </tr>
          ...
          <td width="364"><div align="center"><?php echo $row_permanentAdd['zipcode']; ?></div></td>
          </tr>
          <tr>
  ...
  <div class="container-fluid marg-2 no-print"  style="line-height: .7;">
   <a href="dbmPIMUserIndex.php?perId=<?php echo $row_Recordset1['perId']; ?>" class="btn btn-danger loading bold"> Back</a> 
    ...
    <a href="dbmUserPDSView2.php?perId=<?php echo $row_Recordset1['perId']; ?>" class="btn btn-danger loading bold"> P2 </a> 
   &nbsp; &nbsp;
