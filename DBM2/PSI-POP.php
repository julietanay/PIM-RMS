                        ...
                        <div class="content">
							...
							<table bgcolor="#333" width="100%"><tr>
								...
								Types of Records :
								  ...
								  <td align="right"><h3>
                               <a href=<?php echo "addnewrec.php?typeid=4"; ?> class="btn btn-large btn-inverse pull-right"><i class="icon-plus shaded"></i> Add New</a>
                </h3></td>
								</tr></table>
                                    ...
                                    <tr>
                                     ...
                                     <tbody>
                                         ...
                                         <?php
                                            ...
                                            $agency = mysql_query("SELECT DISTINCT agency FROM file WHERE type_id=4");
                                            $no = 0;
                                            while ($ag=mysql_fetch_array($agency)) {
                                               ...
                                               echo "<td>".$no."</td>";
                                               echo "<td>";
                                               echo "<li><a href='files.php?agency=$agency_name&&type=4'>".$agency_name. "</a></li>";
                                               echo "</td>";
                                               echo "</tr>";
                                            }
