    ...
    <td width="247">
     ...
     <td width="770" ><div>
	   ...
	   <?php 					
		...
		<tr>
		<td colspan=4><p>&nbsp;</p><div align="center"><h4><strong>Educational Background</strong></h4></div></td>
		</tr>
</table>
</td>
  </tr>
      ...
      <tr>
        <td colspan="7"><div align="center">
                <table width="850" border="1">
				 <tr>
					    <td rowspan="2"><div align="center"><strong>Level</strong></div></td>
						<td rowspan="2"><div align="center"><strong>Name of School</strong></div></td>
						<td rowspan="2"><div align="center"><strong>Basic/ Education/ Degree/ Course</strong></div></td>
						<td colspan="2"><div align="center"><strong>Period od Attendance</strong></div></td>
						<td rowspan="2"><div align="center"><strong>Highest Level/  Units Earned</strong></div></td>
						<td rowspan="2"><div align="center"><strong>Years Graduated</strong></div></td>
						<td rowspan="2"><div align="center"><strong>Scholarship/ Academic Honors Received</strong></div></td>
			     </tr>
				 <tr>
						<td><div align="center"><strong>From</strong></div></td>
						<td><div align="center"><strong>To</strong></div></td>				 
				 </tr>
                  <?php $perIdv=$row_Recordset1['perId'];
                  ...
                  <tr>
					<td><div align="center"><?php echo $educLevel ?></div></td>
					<td><div align="center"><?php echo $schoolName ?></div></td>
					<td><div align="center"><?php echo $basicEduc ?></div></td>
					<td><div align="center"><?php echo $educFrom ?></div></td>
					<td><div align="center"><?php echo $educTo ?></div></td>
					<td><div align="center"><?php
					if($highUnitsEarned!=NULL){
						echo $highUnitsEarned;
					}else{
						echo "<small>N/A (Not Applicable)</small>";
					}

					 ?></div></td>
					<td><div align="center"><?php echo $yearGraduated ?></div></td>
					<td><div align="center"><?php echo $scholarship ?></div></td>
				  </tr>
				  <?php } ?>
                    <tr>
                    <td colspan=8><p>&nbsp;</p><p>&nbsp;</p></td>
                  </tr>
				  <tr>
                 <td colspan="8">
...
<p></p>
 <div class="container-fluid marg-2 no-print"  style="line-height: .7;">
   <a href="dbmPIMEducation.php?perId=<?php echo $row_Recordset1['perId'] ?>" class="btn btn-danger loading bold"><i class="icon-chevron-left"></i> Back &nbsp;</a> &nbsp; &nbsp;
