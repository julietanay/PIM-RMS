    ...
    <td width="247">
     ...
     <td width="770" ><div>
	   ...
	   <?php 					
		...
		<tr>
		<td colspan=4><p>&nbsp;</p><div align="center"><h4><strong>OTHER INFORMATION</strong></h4></div></td>
		</tr>
</table>
</td>
  </tr>
      ...
      <tr>
        <td colspan="7"><div align="center">
                <table width="850" border="1">
                  <tr>
                  <td width="162"><div align="center"><strong>No. </strong></div></td>
		...
		$query1="select * from other where other.perId='$perId' order by otherId desc";
					$result1= mysql_query($query1);	
					$count=0;
						 while($row1 = mysql_fetch_assoc($result1)) { 
						$type=$row1['otherType'];
						$desc=$row1['otherDescription'];
					    $count=$count+1;
								 ?>
