    ...
    <td width="247">
     ...
     <td width="770" ><div>
	   ...
	   <?php 					
		...
		<tr>
		<td colspan=4><p>&nbsp;</p><div align="center"><h4><strong>FAMILY BACKGROUND</strong></h4></div></td>
		</tr>
</table>
</td>
  </tr>
      ...
      <tr>
        <td colspan="7"><div align="center">
                <table width="850" border="1">
                  <tr>
                  <td width="162"><div align="center"><strong>Relationship</strong></div></td>
                    <td width="285"><div align="center"><strong>Name</strong></div></td>
                    <td width="203"><div align="center"><strong>Birthday</strong></div></td>
                    <td width="172"><div align="center"><strong>Employment detail</strong></div></td>
                  </tr>
                  <?php $perId=$row_Recordset1['perId']; 
		$query1="select * from family where family.perId='$perId' order by famRelationship desc";
					$result1= mysql_query($query1);	
					$count=0;
						 while($row1 = mysql_fetch_assoc($result1)) { 
						$fname=$row1['famFname'];
						$mname=$row1['famMname'];
						$lname=$row1['famLname'];
						$Maidenname=$row1['famMaidenName'];
						$ext=$row1['famExtName'];
						$bday=$row1['famBday'];
						$relation=$row1['famRelationship'];
						$badd=$row1['famBussAddress'];
						$employ=$row1['famEmployer'];
						$occu=$row1['famOccupation'];
						$telno=$row1['famTelNo'];
						$familyId=$row1['familyId'];;
					    $count=$count+1;
								 ?>
					
                  <tr>
                    <td><div align="center"><?php echo $relation; ?></div></td>
                    <td><?php  echo ' &nbsp;&nbsp; '.$fname.' '.$mname.' '.$lname.' '.$ext.''; 
						if ($relation=='Mother'){
							echo '<small><div><b>&nbsp;&nbsp; Maiden Name : </b>'.$Maidenname.'</div></small>';
						}
                    ...
                    <td><div align="center"><?php
						 ...
						 echo ''.$mon.' '.$day.', '.$Year.' '?></div></td>
                    <td width="33%"><?php if($relation=='Spouse'){ ?>
						 <div><small>&nbsp;<b>Occupation : </b><?php echo $occu; ?></small></div>
						 <div><small>&nbsp;<b>Employer/Business Name : </b><?php echo $employ; ?></small></div>
						 <div><small>&nbsp;<b>Business Address : </b><?php echo $badd; ?></small></div>
						 <div><small>&nbsp;<b>Telephone No. : </b><?php echo $telno; ?></small></div>
					<?php } else {
						echo "<div align='center'>N/A (Not Applicable)</div>";
					}
					?>
					 </td>
                  </tr>
...
<p></p>
 <div class="container-fluid marg-2 no-print"  style="line-height: .7;">
   <a href="dbmPIMPersonnelView.php?perId=<?php echo $row_Recordset1['perId'] ?>" class="btn btn-danger loading bold"><i class="icon-chevron-left"></i> Back &nbsp;</a> &nbsp; &nbsp;
