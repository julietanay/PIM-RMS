        ...
        <div class="wrapper">
            <div class="container">
              ...
              <table bgcolor="#333" width="100%"><tr>
                ...
                <td align="right"><h3>
                               <a href=<?php echo "addnewrec.php?typeid=9"; ?> class="btn btn-large btn-inverse pull-right"><i class="icon-plus shaded"></i> Add New</a>
                </h3></td>
                </tr></table>
                                   ...
                                   <table cellpadding="0" cellspacing="0" border="0" class="table-bordered table-striped   display"
                                    ...
                                    <tr>
                                     ...
                                     <tbody>
                                         ...
                                         <?php
                                         $subtype = mysql_query("SELECT * FROM sub_type WHERE type_id = 9");
                                         $no = 0;
                                         while($rows = mysql_fetch_array($subtype)){
                                            ...
                                            echo "<tr>";
                                            echo "<td>".$no."</td>";
                                            echo "<td><ul><li><a href='files.php?subtype=$stype_id&&type=9'>".$sub."</a>";
