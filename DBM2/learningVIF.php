...
<title>Learning and Development (L&D) Interventions and Training Programs Attended</title>
<style type="text/css">
    .navbar {
    ...
    <td width="247">
     ...
     <td width="770" ><div>
	   ...
	   <?php 					
		...
		<tr>
		<td colspan=4><p>&nbsp;</p><div align="center"><h4><strong> Learning and Development (L&D) Interventions and Training Programs Attended</strong></h4></div></td>
		</tr>
</table>
</td>
  </tr>
      ...
      <tr>
        <td colspan="7"><div align="center">
                <table width="850" border="1">
				 <tr>
					<td rowspan="2"><div align="center"><strong>Title</strong> </div> </td>
					...
					<td rowspan="2"><div align="center"><strong>Type of LD</strong></div></td>
					<td rowspan="2"><div align="center"><strong>Conducted/ Sponsored By</strong></div> </td>
				  </tr>
				  <tr>
					<td><div align="center"><strong>From</strong></div></td>
					<td><div align="center"><strong>To</strong></div></td>
				 </tr>
                  <?php $perIdLearning=$row_Recordset1['perId'];
						 ...
						 $learningId=$rowl['learningId']; 
								 ?>
                  <tr>
					<td><div align="center"><?php echo $learningTitle; ?></div></td>
					<td><div align="center"><?php 
						 $d = date_parse_from_format("Y-m-d", $incluDateFrom);
						 $month=$d["month"];
						 $day=$d["day"];
						 $Year=$d["year"];
						 echo ''.$month.'-'.$day.'-'.$Year;
					?></div></td>
					<td><div align="center"><?php 
						 $d = date_parse_from_format("Y-m-d", $incluDateTo);
						 $month=$d["month"];
						 $day=$d["day"];
						 $Year=$d["year"];
						 echo ''.$month.'-'.$day.'-'.$Year;
					?></div></td>
					<td><div align="center"><?php echo $LearningNOH; ?></div></td>
					<td><div align="center"><?php echo $learningType; ?></div></td>
					<td><div align="center"><?php echo $learningSponsor; ?></div></td>
				  </tr>
				  <?php } ?>
                    <tr>
