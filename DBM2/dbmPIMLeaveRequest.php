...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "vacationApply")) {
  $insertSQL = sprintf("INSERT INTO apply_leave (leaveType, countrySpecify, dateModified, appliedFor, inclusiveDatesFrom,  inclusiveDatesTo, commutation, perId) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['countrySpecify'], "int"),
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "othersApply")) {
  $insertSQL = sprintf("INSERT INTO apply_leave (leaveType, otherSpecify, dateModified, appliedFor, inclusiveDates, commutation, perId) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['leaveType'], "text"),
                       GetSQLValueString($_POST['otherSpecify'], "text"),
                       GetSQLValueString($_POST['dateModified'], "date"),
                       GetSQLValueString($_POST['AppliedFor'], "int"),
                       GetSQLValueString($_POST['InclusiveDate'], "date"),
                       GetSQLValueString($_POST['Commutation'], "text"),
                       GetSQLValueString($_POST['perId'], "int"));
                ...
                <?php	}?>
                  ...
                  <div class="profile-brief"><font color="white"> Legazpi City </font> </div>
                    ...
                    <div id="myalert"  style="display:<?php echo $display ?>;">
                      <div id="header">
                        <form action="dbmPIMLeaveRequest.php?perId=<?php echo $persid;?>" method="post">
                                            ...
                                            <div class="media-body">
													...
													<table class="table">
														<thead>
															...
															<td colspan=7 ><p><h3 align="center" id="StyleLink2">Leave Application for <?php 
									$pertid5=$_SESSION['pidU'];
									$query5 = "SELECT *	FROM personnel WHERE personnel.perId = '$pertid1' ";
											$result5= mysql_query($query5);	
											while($row5= mysql_fetch_assoc($result5)){
								 ...
								 <?php 
									...
									$query5 = "SELECT *	FROM personnel WHERE personnel.perId = '$pertid1' ";
									 ...
									 $query7 = "SELECT * FROM apply_leave, personnel WHERE apply_leave.perId = personnel.perId and  personnel.divId=$divId6";
													...
													$approve14=$row7['Approve1'];
													?>
													
											
															<tr >
															<td width="7%"><div align="center"><?php echo $count7;  ?></div></td>
															<td width="15%"><?php  
															...
															<td width="18%"><?php echo ' '.$appliedFor7.' day(s)';  ?></td>
															<td width="17%"><?php echo ' <div><strong>From : </strong>'.$inclusiveDatesFrom7.'</div> <div><strong>To : </strong>'.$inclusiveDatesTo7.'</div>';  ?></td>
															<td width="13%"><?php echo ' '.$commutation7;  ?></td>
															<td width="13%"><?php if($approve14==null){?>
																	<p><a href="dbmApproveLeave.php?appLeaveId=<?php echo $appLeave7; ?>"><button  onClick="return confirm('Are you sure you want to Approve this Request for Leave?')" class="btn btn-mini btn-success">Approve&nbsp;&nbsp;&nbsp;&nbsp;</button></a> </p>
																	
																<p><a href="dbmDisapproveLeave.php?appLeaveId=<?php echo $appLeave7; ?>"><button  onClick="return confirm('Are you sure you want to cancel this Request for Leave?')" class="btn btn-mini btn-danger">Disapprove</button></a> </p>
															<?php }else if($approve14=="No"){
														  ...
														  <?php	} 	?>
															...
															<td colspan=7><p>No Found Leave</p></td>
															</tr>
															<?php } ?>
